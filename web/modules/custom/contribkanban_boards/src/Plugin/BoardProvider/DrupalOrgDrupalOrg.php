 ...
 *
 * @BoardProvider(
 *   id = "drupalorg_drupalorg",
 *   label = @Translation("Drupal.org"),
 *   description = @Translation("Add a board for Drupal.org project"),
 * )
 */
class DrupalOrgDrupalOrg extends PluginBase implements BoardProviderInterface {
