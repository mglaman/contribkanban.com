(function (angular) {
  ...
  angular.module('appContribkanban')
     ...
     * @todo: Document this.
     */
    .filter('issueBranchFilter', function () {
     ...
     * @todo: Document this.
     */
    .filter('issuePriorityFilter', function () {
     ...
     * @todo: Document this.
     */
    .filter('issueCategoryFilter', function () {
     ...
     * @todo: Document this.
     */
    .filter('issueNeedsFilter', function () {
     ...
     * @todo: Document this.
     */
    .filter('statusLabelFilter', function () {
      var statusCodes = {
        1: 'Active',
        2: 'Fixed',
        3: 'Closed (Duplicate)',
     ...
     * @todo: Document this.
     */
    .filter('categoryLabelFilter', function () {
      var statusCodes = {
        1: 'Bug',
        2: 'Task',
        3: 'Feature',
     ...
     * @todo: Document this.
     */
    .filter('categoryClassFilter', function () {
      var statusCodes = {
        1: 'danger',
        2: 'info',
        3: 'info',
